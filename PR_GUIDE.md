...
- **নিচের সবগুলো শর্ত সত্যি হলে সরাসরি merge করুন, অনুমতি চাইবেন না — শুধু ফলাফল জানিয়ে দিন:**
  ...
  3. কোনো rebase-conflict থাকলে তা `AGENTS.md`-এর "গুরুত্বপূর্ণ সতর্কতা" আইটেম ৭-এর নিয়ম অনুযায়ী মীমাংসিত (নিজে অনুমান করে না, বা তার ব্যতিক্রম-শর্তে)।
...
- **ব্যতিক্রম — এখনো স্পষ্ট অনুমতি লাগবে:**
  ...
  2. rebase-conflict-এ `AGENTS.md` আইটেম ৭ অনুযায়ী যেসব ক্ষেত্রে স্পষ্ট নির্দেশনা লাগে (প্রকৃত বিষয়বস্তু-দ্বন্দ্ব)।
...
**যদি PR-এ real git conflict দেখায়** (দুইটা branch একই লাইনে ভিন্ন পরিবর্তন করেছে — GitHub-এর `mergeable: false`): নিজে অনুমান করে কোনটা রাখবেন ঠিক করবেন না, `AGENTS.md` আইটেম ৭-এর ব্যতিক্রম-নিয়ম মেনে চলুন। Auto-generated ফাইলে conflict কখনো হাতে মার্জ করবেন না — merge-এর পর `main`-এ `build_index.py` এমনিতেই আবার চালাবে।
