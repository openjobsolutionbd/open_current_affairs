...
- **`archive/`** — মাসিক আসল সোর্স ডকুমেন্ট, ফাইনাল ও প্রসেস-করা (বর্তমানে `2026-04.md`; ঐচ্ছিক, নিয়মিত রক্ষণাবেক্ষণ হয় না)।
...
## নতুন মাসের তথ্য যোগ করা (এক-ধাপ ওয়ার্কফ্লো)

ম্যাগাজিন পেজের ছবি Claude-কে দাও। Claude OCR করে, নিজে জুম করে রিচেক করে, অনিশ্চিত কিছু থাকলে (নাম/সংখ্যা/তারিখ) অনুমান না করে জিজ্ঞেস করে কনফার্ম করিয়ে নেয় — প্রয়োজনে ওয়েব সার্চে যাচাই করে। `scripts/check_topic.sh` দিয়ে ডুপ্লিকেট-চেক করে নেয়। কনফার্মেশনের পর কোনো intermediate staging ফাইল ছাড়াই **সরাসরি** সংশ্লিষ্ট গন্তব্যে বসায় — `docs/topics/*.md` (স্থায়ী বিষয়), `docs/ghotonaprobaho/*.md` (তারিখ-ভিত্তিক ঘটনা), `docs/top-news/*.md` (হাইলাইট), বা `docs/mcq/*.md` (MCQ আর্কাইভ)। তারপর `scripts/build_index.py` + `scripts/verify_site.py` (একসাথে `scripts/preflight.sh`) দিয়ে validate করে commit ও push করে।

এই পুরো প্রক্রিয়ায় Claude `EDITORIAL_MEMORY.md`-এ জমা হওয়া আগের সিদ্ধান্তগুলো মেনে চলে, আর নতুন কোনো স্থায়ী-যোগ্য সিদ্ধান্ত এলে সেখানে নিজে থেকেই যোগ করে রাখে। বিস্তারিত `PROJECT.md`-এর ৭নং সেকশনে।

*(২০২৬-০৮ পর্যন্ত এখানে `archive-staging/` ফোল্ডারভিত্তিক ৩-ধাপ staging ওয়ার্কফ্লো ছিল — একাধিক সমান্তরাল সেশনের সংঘর্ষ এড়াতে ব্যবহারকারীর সিদ্ধান্তে বাদ দেওয়া হয়েছে।)*
