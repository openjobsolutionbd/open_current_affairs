...
- **`docs/index.html`** — সার্চ, টপিক পড়া, দৈনিক ঘটনাপ্রবাহ, সাম্প্রতিক পরিবর্তন, প্রিন্ট/শেয়ার ও ডার্ক মোডসহ static website। Cloudflare Pages দিয়ে হোস্ট করা হয়।
...
- **🕘 সাম্প্রতিক পরিবর্তন** — আলাদা view টগল করে কোন টপিক কবে/কী আপডেট হলো তার তালিকা (`docs/recent-changes.json`, প্রতিটা টপিকের "পরিবর্তনের ইতিহাস" থেকে build-এর সময় স্বয়ংক্রিয়ভাবে তৈরি হয়), মাস অনুযায়ী গ্রুপ করা ও prev/next নেভিগেশনসহ। প্রতিটা এন্ট্রি ক্লিক করলে সরাসরি সেই টপিক খুলে যায়।
