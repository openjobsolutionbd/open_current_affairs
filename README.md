...
টপিক-ভিত্তিক কারেন্ট অ্যাফেয়ার্স knowledge-base। প্রতি মাসে নতুন তথ্য `topics/`-এর টপিক পেজে যোগ হয় এবং প্রতিটি পেজে পরিবর্তনের ইতিহাস থাকে।

## এই রিপোতে কী কী আছে

- **`topics/`** — মূল কনটেন্ট। প্রতিটি ফাইলে "বর্তমান তথ্য" ও "পরিবর্তনের ইতিহাস" অংশ থাকে।
...
- **`docs/topics/`**, **`docs/recent-changes.json`**, **`docs/sw.js`**, **`docs/version.json`** — build-এর সময় তৈরি হওয়া website output; হাতে edit করবে না।
...
`topics/`-এ পরিবর্তন করলে `scripts/build_index.py` চালিয়ে generated output আপডেট করতে হবে। GitHub Action এটি স্বয়ংক্রিয়ভাবে করে থাকলে আলাদা করে চালাতে হবে না।
...
আরও বিষয় যোগ করতে `topics/`-এ নতুন valid topic file তৈরি করো।
