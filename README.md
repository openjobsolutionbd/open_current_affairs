...
- **`archive/`** — মাসিক আসল সোর্স ডকুমেন্ট, ফাইনাল ও প্রসেস-করা (বর্তমানে `2026-04.md`)।
- **`archive-staging/`** — কাঁচা/আনভেরিফাইড OCR স্টেজিং, `archive/`-এর থেকে আলাদা (দেখুন `PROJECT.md`-এর "আর্কাইভ ম্যানেজমেন্ট" সেকশন)।
...
## নতুন মাসের তথ্য যোগ করা (৩-ধাপ আর্কাইভ ওয়ার্কফ্লো)

**ধাপ ১ — স্টেজিং:** ম্যাগাজিন পেজের ছবি Claude-কে দাও। Claude OCR করে, নিজে রিচেক করে, অনিশ্চিত কিছু থাকলে জিজ্ঞেস করে কনফার্ম করিয়ে নেয়, তারপর verbatim `.md` ফাইল হিসেবে `archive-staging/YYYY-MM/`-এ জমা রাখে (বিস্তারিত `archive-staging/README.md`-এ)।

**ধাপ ২ — প্রসেসিং:** সব পেজ কনফার্ম হয়ে গেলে, আলাদা সেশনে বলো: "স্টেজিং-এর এই সংখ্যা প্রসেস করো।" Claude তখন `EDITORIAL_MEMORY.md`-এর নিয়ম মেনে কনটেন্ট সংশ্লিষ্ট টপিক/ঘটনাপ্রবাহ/MCQ/টপ-নিউজে ভাগ করে নেয়, প্রতিটা টপিকের বর্তমান তথ্য ও পরিবর্তনের ইতিহাস আপডেট করে, নতুন বিষয় হলে নতুন topic file বানায়।

**ধাপ ৩ — ফাইনাল আর্কাইভ:** প্রসেসিং সম্পূর্ণ হলে, কনটেন্ট মাসিক ফাইল হিসেবে `archive/`-এ যায় (স্টেজিং থেকে মুছে না ফেলে)। পরিবর্তন GitHub-এ push করলে generated search index স্বয়ংক্রিয়ভাবে আপডেট হবে।

এই পুরো প্রক্রিয়ায় Claude `EDITORIAL_MEMORY.md`-এ জমা হওয়া আগের সিদ্ধান্তগুলো মেনে চলে, আর নতুন কোনো স্থায়ী-যোগ্য সিদ্ধান্ত এলে সেখানে নিজে থেকেই যোগ করে রাখে।
