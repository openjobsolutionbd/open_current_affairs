...
| `.github/workflows/update-wiki.yml` | `main`-এ push (অর্থাৎ PR merge) হলে GitHub Actions স্বয়ংক্রিয়ভাবে build+verify চালায়। পরিবর্তন থাকলে `auto/rebuild-output` branch-এ push করে PR খোলে/আপডেট করে (branch protection-এর কারণে bot সরাসরি `main`-এ push করতে পারে না — ২০২৬-০৮-১৩ থেকে এই নিয়ম)। **এই push+PR-create ধাপে `secrets.GITHUB_TOKEN` নয়, `secrets.BOT_PAT` (একটা repo secret হিসেবে সেভ করা personal access token) ব্যবহার করা হয়** — কারণ `GITHUB_TOKEN`-চালিত push/PR-create কখনোই downstream workflow (`pr-check.yml`) ট্রিগার করে না (GitHub-এর ইচ্ছাকৃত recursive-loop-প্রতিরোধ নিয়ম, branch নতুন/পুরনো তাতে কিছু যায়-আসে না — এটা ধরতে দুই দফা ভুল diagnosis লেগেছিল, PR #22 ও #36 দেখুন)। `BOT_PAT` মেয়াদ ফুরোলে বা revoke হলে এই মেকানিজম আবার নীরবে ভেঙে যাবে — নতুন token বানিয়ে `Settings → Secrets and variables → Actions → BOT_PAT` আপডেট করতে হবে। এই bot-PR merge করার আগেও ব্যবহারকারীর স্পষ্ট অনুমতি লাগবে, `scripts/pr_checks.py` শুধু generated-ফাইল guard থেকে এটাকে exempt করে (auto-merge policy আলাদা বিষয়) |
...
**(সিদ্ধান্ত, ২০২৬-০৮-১১):** এই "merge-অনুমোদন" অংশটা GitHub-এর নিজস্ব "approve" ফিচার দিয়ে প্রযুক্তিগতভাবে বাধ্যতামূলক করা সম্ভব ছিল। কিন্তু তার জন্য একটা দ্বিতীয় GitHub অ্যাকাউন্ট লাগত এবং প্রতি merge-এ বাড়তি সমন্বয়/টোকেন খরচ হতো। ব্যবহারকারী কম-খরচের বিকল্প বেছে নিয়েছিলেন। **এটা মূল উদ্বেগ (সংঘর্ষ/সরাসরি-পুশ প্রতিরোধ) থেকে সম্পূর্ণ আলাদা** — সেটা branch protection দিয়ে সম্পূর্ণ প্রযুক্তিগতভাবেই বাধ্যতামূলক, নিচের কোনো সিদ্ধান্তেই তার হেরফের নেই।

**(সিদ্ধান্ত, ২০২৬-০৮-১২, পরিমার্জিত ২০২৬-০৮-১৫): সব PR-এ auto-merge — "মার্জ করো" শোনার অপেক্ষা আর নেই।** প্রথমে শুধু কম-ঝুঁকির PR-এ auto-merge চালু হয়েছিল, কিন্তু প্রতি PR-এ অনুমতির অপেক্ষা করা ব্যবহারকারীর জন্য ক্লান্তিকর মনে হওয়ায় ব্যবহারকারী নিজে এই ধাপটা পুরোপুরি বাদ দিতে বলেছেন। এখন থেকে নিয়ম:
