...
| `PR_GUIDE.md`, `MCQ_GUIDE.md`, `STAGING_GUIDE.md` | প্রসঙ্গ-ভিত্তিক এজেন্ট-নির্দেশনা — কখন পড়বেন উপরের টেবিলে |
...
- **একই বিষয় যেখানেই পাওয়া যাক, existing টপিকে merge করুন, নতুন আলাদা টপিক না।** সোর্সে একই বিষয় একাধিক জায়গায় থাকা স্বাভাবিক। নতুন টপিক লেখার আগে (বা MCQ merge করার সময়, দেখুন `MCQ_GUIDE.md`) existing টপিকে আছে কিনা যাচাই করুন — থাকলে সেখানেই আপডেট করুন ("পরিবর্তনের ইতিহাস"-এ নতুন সারি), পাশাপাশি দুইটা প্রায়-অভিন্ন টপিক না। এই সিদ্ধান্ত সবসময় নিজে পড়ে-বুঝে নিন, script/regex দিয়ে স্বয়ংক্রিয় না।
  - এটা `docs/ghotonaprobaho/`ও `docs/top-news/`-এ প্রযোজ্য না — এগুলো তারিখ-ভিত্তিক লগ, একই বিষয়ে ভিন্ন তারিখের খবর আলাদা ঘটনা হিসেবেই থাকে। এই দুইয়ের নিয়ম: একই তারিখ-হেডিং-এ ডুপ্লিকেট-চেক + সংলগ্ন রেঞ্জ হলে `git mv` দিয়ে rename (বিস্তারিত `STAGING_GUIDE.md`-এ)।
...
### চলমান কাজ: প্রফেসর'স কারেন্ট অ্যাফেয়ার্স জুলাই ২০২৬ সংখ্যা

সোর্স: `july_2026.zip` (৪৫ পেজ, ছাপা পেজ-নম্বর অনুযায়ী, ফাইল-ক্রম না)। কাজের আগে `check_topic.sh` দিয়ে বাকি আছে কিনা যাচাই করুন। ২০২৬-০৮-২১ পর্যন্ত শুধু বাকি:
- "দেশ পরিক্রমা"-র উন্নয়ন কর্তৃপক্ষের তালিকা — ব্যবহারকারী নিজে স্পষ্ট ছবি দেবেন
- বাদ (অপরিবর্তিত): "অনন্তলোকে" — MCQ আলাদা, বাদ না (`MCQ_GUIDE.md`)

সোর্স পেজ জুম করে সরাসরি পড়ুন, ডুপ্লিকেট চেক করুন, build validate করুন, branch+PR দিয়ে merge করুন।
